	...
	<div class="panel panel-info ">
		<div class="panel-heading">
			 <div class="btn-group pull-right">
				<button type='button' class="btn btn-info" style="background-color: #568435" onclick="location='reporte/index.php'" ><span class="glyphicon glyphicon-plus" ></span> Crear Reporte </button>
			</div>

		    <div class="btn-group pull-right">
				<button type='button' class="btn btn-info" style="background-color: #568435" data-toggle="modal" data-target="#nuevoInvento"><span class="glyphicon glyphicon-plus" ></span> Crear Registro </button>
			</div>
		...
		<div class="panel-body">
			...
			include("modal/reporte_quincenal.php");
